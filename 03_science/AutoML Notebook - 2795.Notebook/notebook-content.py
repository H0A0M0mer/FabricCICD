...
mlflow.set_experiment("MLM_Demo-AutoMLExperiment")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "MLM_Demo-AutoMLExperiment",  # MLflow experiment name
...
with mlflow.start_run(nested=True, run_name="MLM_Demo"):
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="MLM_Demo")
