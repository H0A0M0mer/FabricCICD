...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "total_revenue")
...
mlflow.set_experiment("EXP_Demo")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "EXP_Demo",  # MLflow experiment name
...
with mlflow.start_run(nested=True, run_name="EXP_Demo-AutoMLModel"):
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="EXP_Demo-AutoMLModel")
...
model_name = "EXP_Demo-AutoMLModel"
...
saved_name = "Tables/dbo/sales_orders_predictions".replace(".", "_")
